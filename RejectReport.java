...
class RejectReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	RejectReport()
	{
		...
		date3=new java.util.Date();
		 ...
		 JLabel h2=new JLabel("Rejected Item Report");
		...
		try
		{
			...
			String[] colHeads = { "Date", "Distributor Id", "Distributor Name", "Particular", "Purchase Cost","Reject Qty","Amount"};

			rs = st.executeQuery("select * from reject");
			...
			fm=new JFrame("Rejection Report");
	 ...
	 public static void main(String args[])
	  {
	     RejectReport rr=new RejectReport();
	  }
