...
class PurchaseReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	PurchaseReport()
	{
		...
		date3=new java.util.Date();
		 ...
		 JLabel h2=new JLabel(" Report of  purchases");
		...
		try
		{
			...
			String[] colHeads = { "Date","Distributor ID","Customer Name", "Particular","Purchase Cost","Quantity","Amount","Amount Type","C/D no."};

			rs = st.executeQuery("select * from pbill");
