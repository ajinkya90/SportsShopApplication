   ...
   public report1(){
         try{
		    ...
		    lavailable.setBounds(300,250,120,20);
                ...
                r1=new JRadioButton("For Indoors");
                r1.setBounds(150,130,70,25);
		        r2=new JRadioButton("For Outdoors");
		        r2.setBounds(250,130,100,25);
		        r3=new JRadioButton("For Accessories");
                   ...
                   try{
                         rs1 = s1.executeQuery("select * from sbill");
                             ...
                             if(s.equals(rs1.getString(3)))
                             {
                               ...
                               int b11 = Integer.parseInt(txtbal.getText());
                               if(b11 == 0)
                               {
                                      btnRec.setEnabled(false);
                               }
                               else{btnRec.setEnabled(true);}
                               }
                            }
                        rs1.close();
                        }
        ...
        public void actionPerformed(ActionEvent e1)
       {
              ...
              if(obj==btnRec){
                  try{
                       ...
                       String b="0";
                       String n="No";
                       int billno = Integer.parseInt(lbno.getText());
                       String q = "UPDATE sbill SET paid='"+txtTot.getText()+"',"+
                                  ...
                                  cname.clearSelection();
                                  txtbal.setText("0");
                                  txtpaid.setText(txtTot.getText());
                                  System.out.println(a);
                                  String msg= " Total Amount Recieved!!!";
