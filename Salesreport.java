...
class SaleReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	SaleReport()
	{
		...
		date3=new java.util.Date();
		 ...
		 JLabel h2=new JLabel("Sales Report");
		...
		try
		{
			...
			String[] colHeads = { "Bill no.","Date", "Customer Name", "Phone no.","Total amt.","Paid","Balance","Bill Pending"};

			rs = st.executeQuery("select * from sbill");
			...
			Object[][] results = new Object[count][8];
			rs.first();
