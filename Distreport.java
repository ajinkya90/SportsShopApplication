...
class DistReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	DistReport()
	{
		...
		date3=new java.util.Date();
		 ...
		 JLabel h2=new JLabel("Distributors Report");
		...
		try
		{
			...
			String[] colHeads = { "Distributor Id", "Distributor Name", "Distributor Address", "Distributor Phone","Distributor Mobile","Distributor For"};

			rs = st.executeQuery("select * from distinfo");
