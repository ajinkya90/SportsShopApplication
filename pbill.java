...
class pbill extends JPanel implements ActionListener,ItemListener
{
      Container c1;
      JFrame fpbill;
      JPanel pbill;
      JLabel ldisp,lsubmitr1,l4,l6,l7,ldistid,ldistname,lperti,lpcost,lquantity,lamount,lamtype,lcdno;
      JTextField distname,distid,distfor,pcost,quantity,amount,cdno,tf1,tf2;
      JComboBox perti;
      Thread datimeThread;
	  Date date;
